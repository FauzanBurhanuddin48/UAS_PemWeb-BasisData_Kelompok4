...
<head>
    ...
    <title>Programming di RumahCatur.</title>
...
<body>
    <nav>
        <div class="wrapper">
            <div class="logo"><a href='<?php echo url_dasar()?>'>Csmarthome</a></div>
            <div class="menu">
                <ul>
                    ...
                    <?php if(isset($_SESSION['members_nama_lengkap'])){
                        echo "<a href='".url_dasar()."/login-forum.php'>Forum</a> | <a href='".url_dasar()."/ganti_profile.php'>".$_SESSION['members_nama_lengkap']."</a>  |  <a href='".url_dasar()."/logout.php'>Logout</a>";
                    }else{?>
